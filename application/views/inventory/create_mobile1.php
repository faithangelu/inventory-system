...
<div class="container" id="inventory-count">
  <form role="form" action="<?php echo base_url('inventory/create') ?>" method="post" id="createForm">
  <div class="row">
      ...
      <div class="swiper-container">        
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            ...
            <?php foreach ($store_branch as $key => $value) : ?>
            <li class="list-group name"><input type="text" name="" class="form-control input-sm"></li>
            <?php endforeach; ?>
            </ul>
          </div>
          <div class="swiper-slide">
          ...
          <div class="swiper-slide">
            ...
            <li class="list-group px-3">Notes </li>
              <input type="text" name="" class="form-control input-sm"></li>
            <?php foreach ($store_branch as $key => $value) : ?>
